(function () {
    ...
    // Jika jQuery tersedia, inisialisasi datepicker untuk input tanggal (Vue + jQuery integration example)
    if (window.jQuery) {
        (function($){
            $(function(){
                // datepicker for the "new todo" inputs
                    ...
                    if (!$(this).hasClass('hasDatepicker')) {
                        $(this).datepicker({
                            ...
                            onSelect: function(dateText){
                                ...
                                if (!window.$app || !window.$app.editingDraft) return;
                                if (field === 'start') window.$app.editingDraft.startDate = dateText;
                                else if (field === 'due') window.$app.editingDraft.dueDate = dateText;
                            }
                        });
                    }
                });
